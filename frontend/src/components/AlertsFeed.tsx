      ...
      <div className="p-4 border-b border-zinc-800/80 bg-zinc-900/20 space-y-3 shrink-0">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-xl border border-zinc-800/80 bg-zinc-950/40 py-2 pl-10 pr-4 text-sm text-white placeholder-zinc-500 outline-none transition-all focus:border-red-500/50"
          />
        </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2.5 pt-1">
          ...
          <select
            ...
            className="rounded-lg border border-zinc-800 bg-zinc-950 text-xs text-zinc-400 py-1.5 px-2.5 outline-none focus:border-zinc-700 cursor-pointer"
          >
        ...
        {/* Severity Tabs */}
        <div className="flex gap-1 overflow-x-auto pb-1 border-t border-zinc-800/40 pt-2.5 shrink-0 scrollbar-none">
          {['all', 'critical', 'high', 'medium', 'low'].map((sev) => {
            ...
            const style = isSelected 
              ? sev === 'critical'
                ...
                : sev === 'high'
                ? 'bg-red-600 text-white font-semibold shadow-[0_0_10px_rgba(220,38,38,0.4)]'
                : sev === 'medium'
                ? 'bg-orange-600 text-white font-semibold shadow-[0_0_10px_rgba(249,115,22,0.4)]'
                : sev === 'low'
                ? 'bg-yellow-600 text-white font-semibold shadow-[0_0_10px_rgba(202,138,4,0.4)]'
